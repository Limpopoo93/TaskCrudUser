...
**DeadLock** - ситуация когда 2 и более потока блокируют друг друга и ждут <br>
  освобождения ресурсов которые сами и заблокировали.<br>
...
Предотвратить можно: 1. Упорядочивание блокировок. 2. Использование таймаутов. <br>
3. Использование ExecutorService, ConcurrentHashMap
...
Избежать можо: добавление thread.sleep(), ограничение попыток выполнения в циклах
