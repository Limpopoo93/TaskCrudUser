...
Абстрактный класс - в абстрактном классе хранится у нас состояние и описывать поведение класса. позволяющее избежать написания повторяющегося кода
тоесть когда мы хочем вынести код и состояние которые он модифицирует мы не могли использовать в нескольких местах
Интерфейс - в интерфейсе у нас только контракт. это средство выражения семантики класса, контракт, описывающий возможности.
