...
Тип===Размер (бит)===Диапазон значений<br>
byte===8===========	-128 до 127	byte <br>
short==16=========-32,768 до 32,767	short<br>
int====32====-2³¹ до 2³¹ <br>
long====64====-2⁶³ до 2⁶³ <br>

float===32=====~ ±3.4e+38 (7 значащих цифр)<br>
double===64====~ ±1.7e+308 (15 значащих цифр) <br>

char====16====0 до 65,535 (беззнаковый, Unicode) <br>
boolean====1 (не точно)====true или false;
...
CI\CD - это автоматизация процессов интеграции и доставки кода. <br>
CI (Continuous Integration) — автоматическая сборка и проверка кода после каждого коммита. <br>
CD (Continuous Deployment/Delivery) — автоматический деплой в тестовые или продакшен-среды. <br>
...
S - единственной ответственности. O - открытости\закрытости. I - Разеделения интерфейса
...
2. Мост (Bridge) - Структура, позволяющая изменять интерфейс обращения и интерфейс реализации класса независимо.
   ...
   `   
3. Компоновщик (Composite) - Объединяет объекты в древовидные структуры.
   Пример: GUI-компоненты (контейнеры + кнопки)
