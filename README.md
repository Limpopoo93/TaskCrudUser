...
1. **Инкапсуляция** - скрывает детали реализации объекта внутри, предоставляя<br>
   только необходимы методы для использования.<br>
3. **Наследование** - добавляет возможность создавать новые классы на основе<br>
   существующих, добавляя в них новую необходимую логику.<br>
5. **Полиморфизм** - позволяет объектам с одинаковым интерфейсом иметь различную<br>
   реализацию.<br>

**Ассоциация** - объекты двух классов могут ссылаться один на другой, имея связь<br>
  друг с другом.(Типы: один к одному, Многие ко многим) <br>
**агрегация** - ассоциация со слабой связью. односторонняя связь с одноправленным<br>
  отношением. (Пример: двигатель и автомобиль) <br>
**композиция** - это ассоциация с сильной связью. Когда класс владеет объектом и<br>
  несет ответственность за его время жизни. (сотрудник и роль)
...
**IoC (Inversion of Control)** — это принцип передачи управления созданием объектов <br>
контейнеру. Вместо ручного внедрения зависимостей, фреймворк берет это на себя <br>
